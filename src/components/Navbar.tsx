...
// Using standard anchor tags for hash links instead of Next.js Link
import { useEffect, useState } from 'react'
import { FaBlog, FaBriefcase, FaCode, FaEnvelope, FaProjectDiagram, FaUser, FaGithub} from 'react-icons/fa'
